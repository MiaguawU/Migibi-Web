...
@unidad_medida_bp.post("/tipo-alimento/")
...
@unidad_medida_bp.get("/tipo-alimento/", response_model=List[TipoAlimentoSchema])
...
@unidad_medida_bp.post("/unidad-medida/")
...
@unidad_medida_bp.get("/unidad-medida/", response_model=List[UnidadMedidaSchema])
...
@unidad_medida_bp.delete("/tipo-alimento/{id}")
