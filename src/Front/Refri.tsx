...
import { AutoComplete, Input, Button, ConfigProvider, Card, Space, Tooltip, message, Spin, Popconfirm } from 'antd';
                    ...
                    <Space size="small" style={{ marginTop: '10px' }}>
                      ...
                      <Tooltip title="Eliminar">
                        <Popconfirm
                                            ...
                                            description="¿Está seguro de borrar este alimento?"
                                            onConfirm={() => eliminarAlimento(card.id)}
                                            onCancel={(e) => e?.stopPropagation()}
                                            okText="Sí"
                                            cancelText="No"
                                          >
                        <DeleteOutlined style={{ color: customColors.colorError, fontSize: 20 }} />
                          </Popconfirm>
                      </Tooltip>
                    </Space>
